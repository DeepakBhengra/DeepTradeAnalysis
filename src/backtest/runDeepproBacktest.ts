...
export function collectDeepproTradingDates(snapshots: IndicatorSnapshot[]): string[] {
  const { sessionStart, sessionEnd } = config.deeppro;
...
export function runDeepproBacktest(
