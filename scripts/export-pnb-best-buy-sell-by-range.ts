...
const SRC = resolve(REPORTS_DIR, "pnb-all-best-buy-sell-60d.json");
...
const RANGES: RangeDef[] = [
  { id: "high", label: "3% – 1.8%", minPct: 1.8, maxPct: 3.0 },
...
function main(): void {
  ...
  const mdPath = resolve(REPORTS_DIR, "pnb-best-buy-sell-by-range-60d.md");
  const jsonPath = resolve(REPORTS_DIR, "pnb-best-buy-sell-by-range-60d.json");
